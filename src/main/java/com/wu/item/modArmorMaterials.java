...
public enum modArmorMaterials implements StringIdentifiable, ArmorMaterial {
    TITANIUM_ALLOY("titanium_alloy", 39, Util.make(new EnumMap(ArmorItem.Type.class), map -> {
        map.put(ArmorItem.Type.BOOTS, 3);
        map.put(ArmorItem.Type.LEGGINGS, 6);
        map.put(ArmorItem.Type.CHESTPLATE, 8);
        map.put(ArmorItem.Type.HELMET, 3);
    }), 25, SoundEvents.ITEM_ARMOR_EQUIP_NETHERITE, 3.0F, 0.1F, () -> Ingredient.ofItems(modItems.TITANIUM_ALLOY_INGOT));
    ...
    public String getName() {
        return TitaniumUpdate.MOD_ID + ":" +  this.name;
    }
